...
/*
   The Rust type str is a primitive type, closely related to String. The most common
...
fn main() {
    ...
    println!("The poetry line's bytes start out: {:?}", bytes_ptr); // {:?} is 'debug' format mode
